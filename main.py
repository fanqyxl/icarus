...
scriptUrl = "https://ddl.fanqyxl.net/api/v1/download?path=%2FScripts%2FIcarus%2Fmain.py" # URL of the file where the latest script version is stored
sslCerts = {
    ...
    "myCA.pem": "https://ddl.fanqyxl.net/api/v1/download?path=%2FChromeOS%2FPrebuilts%2FIcarus%2FIcarus-Certs%2FmyCA.key",
    "myCA.key": "https://ddl.fanqyxl.net/api/v1/download?path=%2FChromeOS%2FPrebuilts%2FIcarus%2FIcarus-Certs%2FmyCA.pem"
} # Stores names and links of certificates to download
certPaths = {} # Stores paths of certificates on the local filesystem
installationFolder = "Certs" # Folder name that stores certificates
